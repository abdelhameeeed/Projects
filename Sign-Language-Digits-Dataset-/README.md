...
##I trained This images  on Google colab , i want to give an intiution about how is the CNN architicture is so powerful in detecting a patterns in images and it makes a good job on predicting unseen images in the future and it is clear in mu Notebook , you will see that the accuracy of CNN is more accecptable Than other Fully connected Netwroks that i Trained it too , to see the difference 
